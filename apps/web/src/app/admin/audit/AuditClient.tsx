...
import { AdminPage, DataPanel, EmptyState, FilterBar, PageHeader, Pagination, SearchField, SelectField, StatCard, StatusBadge } from "@/components/admin/ui";
...
export function AuditClient({ rows }: { rows: AuditRow[] }) {
  ...
  return (
    <AdminPage>
      <PageHeader eyebrow="Admin / Hệ thống / Nhật ký" title="Nhật ký hệ thống" description="Theo dõi thao tác quan trọng: đăng nhập, tạo đơn, nhập kho, thanh toán, hoàn tiền và thay đổi trạng thái." />
